package com.bitbot.copilot.data.remote.api

import com.bitbot.copilot.data.remote.dto.ControlMappingDto
import com.bitbot.copilot.data.remote.dto.HeadersResponseDto
import com.bitbot.copilot.data.remote.dto.StatesListResponseDto
...
class RobotApi @Inject constructor(
    ...
    suspend fun getStatesList(baseUrl: String): Result<StatesListResponseDto> = runCatching {
        val request = Request.Builder()
            ...
            .get()
            .header("User-Agent", "BITBOT COPILOT")
            .build()
